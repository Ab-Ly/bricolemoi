...
## Corpus Check
- 95 files · ~223,398 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 358 nodes · 722 edges · 67 communities (32 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7078934a`
...
Cohesion: 0.13
Nodes (25): AdminClientsView(), AdminDisputesView(), AdminLiveMissions(), AdminMaalemsView(), AdminRechargesView(), CATEGORIES_TAXONOMY, CategorySelector(), EnhancedCategoryIcon() (+17 more)

### Community 3 - "ClientView.jsx"
Cohesion: 0.13
Nodes (21): CGUModal(), ClientView(), getServiceDisplay(), mapCategoryToSlug(), SERVICE_TYPE_MAP, CustomDropdown(), getSafeLabel(), SPECIALTY_CONFIG (+13 more)
...
## Knowledge Gaps
- **76 isolated node(s):** `recentRequests`, `name`, `private`, `version`, `type` (+71 more)
