  ...
  `},ue=k=>{const t=String(k||"").toUpperCase();return t.includes("CLIM")||t.includes("FROID")||t.includes("HVAC")||t.includes("AIR")?x.CLIMATISATION:t.includes("PLOMB")||t.includes("PLUMB")||t.includes("EAU")?x.PLUMBING:t.includes("ELEC")||t.includes("VOLT")||t.includes("COURANT")?x.ELECTRICIAN:t.includes("AUTO")||t.includes("CAR")||t.includes("LAVAGE")||t.includes("MECAN")?x.AUTO_MECHANIC:t.includes("MENUIS")||t.includes("CARPENTER")||t.includes("WOOD")||t.includes("BOIS")?x.MENUISERIE:t.includes("SERRUR")||t.includes("KEY")||t.includes("LOCK")||t.includes("PORTE")?x.SERRURERIE:t.includes("PEINT")||t.includes("PAINT")||t.includes("DECO")?x.PEINTURE:t.includes("MACON")||t.includes("BRICK")||t.includes("BATIMENT")||t.includes("CIMENT")?x.MACONNERIE:t.includes("ELECTRO")||t.includes("MULTIMEDIA")||t.includes("TV")?x.ELECTROMENAGER:t.includes("JARDIN")||t.includes("GARDEN")||t.includes("PLANT")?x.JARDINAGE:t.includes("NETT")||t.includes("MENAGE")||t.includes("CLEAN")?x.NETTOYAGE:t.includes("DERAT")||t.includes("DESINF")||t.includes("PEST")?x.DERATISATION:t.includes("PISCINE")||t.includes("POOL")||t.includes("WAVE")?x.PISCINE:x.PLUMBING},Ge=({mode:k="CLIENT_PICKER",selectedLat:t,selectedLng:h,onLocationSelect:y,filterCategory:xe})=>{var oe;const{user:j}=Me(),{interventions:O,maalems:T,calculateDistanceInKm:K,showToast:M,isMaalemOnline:je,toggleMaalemOnlineStatus:Te}=Ce(),Y=!!(j&&(String(j.role||"").toUpperCase()==="MAALEM"||String(j.role||"").toUpperCase()==="ADMIN")),V=p.useRef(null),f=p.useRef(null),I=(()=>{try{return JSON.parse(localStorage.getItem("bricolemoi_client_gps")||"null")}catch{return null}})(),J=t||(I==null?void 0:I.lat)||33.5883,W=h||(I==null?void 0:I.lng)||-7.6328,[R,fe]=p.useState("OSM_FR"),[q,me]=p.useState("GOLD_CYAN"),[i,Q]=p.useState({lat:J,lng:W}),[A,X]=p.useState({}),[ee,te]=p.useState(!1),[w,U]=p.useState(!1),[se,$]=p.useState(!1),[re,z]=p.useState(!1),C=p.useRef({}),g=p.useRef({}),E=p.useRef(null),v=p.useRef(null);p.useEffect(()=>{if(!V.current)return;E.current=null,v.current=null,C.current={},g.current={};const s=new Ne({container:V.current,style:ke(R),center:[W,J],zoom:14.5,minZoom:10,maxZoom:19,pitch:0,bearing:0,antialias:!0,attributionControl:!1});s.addControl(new ye({showCompass:!0}),"top-right"),f.current=s,s.on("load",()=>{te(!0),s.resize()});const o=setTimeout(()=>{s&&s.resize()},200);return s.on("click",n=>{y&&y(n.lngLat.lat,n.lngLat.lng)}),()=>{clearTimeout(o),E.current=null,v.current=null,C.current={},g.current={},te(!1),s.remove()}},[R]),p.useEffect(()=>{f.current&&t&&h&&f.current.flyTo({center:[h,t],zoom:14.5,speed:1.2})},[t,h]),p.useEffect(()=>{const s={};(T||[]).forEach(n=>{s[n.id]={lat:n.lat,lng:n.lng}}),X(s);const o=setInterval(()=>{X(n=>{const l={...n};return(T||[]).forEach(d=>{const u=l[d.id]||{lat:d.lat,lng:d.lng};if(u.lat&&u.lng){const r=(Math.random()-.5)*2e-4,a=(Math.random()-.5)*2e-4;l[d.id]={lat:u.lat+r,lng:u.lng+a}}}),l})},4e3);return()=>clearInterval(o)},[T]),p.useEffect(()=>{const s=f.current;if(!s||!ee)return;if(E.current)E.current.setLngLat([i.lng,i.lat]),E.current.getElement().parentNode||E.current.addTo(s);else{const r=document.createElement("div");r.style.width="36px",r.style.height="36px",r.className="relative flex items-center justify-center cursor-pointer",r.innerHTML=`
      ...
      `;const a=new H({offset:25,className:"clean-trust-popup"}).setHTML(`<div class="bg-white/95 backdrop-blur-xl border border-slate-200/90 p-3 rounded-2xl text-center shadow-xl font-sans">
        ...
        `;const a=new H({offset:25,className:"clean-trust-popup"}).setHTML(`<div class="bg-white/95 backdrop-blur-xl border border-slate-200/90 p-3 rounded-2xl text-center shadow-xl font-sans">
          ...
          </div>`);C.current[r.id]=new P({element:b}).setLngLat([m,c]).setPopup(he).addTo(s)}}),Y?O.filter(a=>a.status==="PENDING").forEach(a=>{const c=parseFloat(a.lat||33.5883),m=parseFloat(a.lng||-7.6328);if(isNaN(c)||isNaN(m))return;const G=ue(a.service_type),_=K(i.lat,i.lng,c,m);if(g.current[a.id])g.current[a.id].setLngLat([m,c]),g.current[a.id].getElement().parentNode||g.current[a.id].addTo(s);else{const N=document.createElement("div");N.style.width="44px",N.style.height="44px",N.style.willChange="transform",N.className="relative flex items-center justify-center cursor-pointer transform transition-transform hover:scale-125",N.innerHTML=`
