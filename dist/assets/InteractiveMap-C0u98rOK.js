import{j as e,m as L}from"./motion-vendor-tYxtgyNX.js";import{r as c,b8 as be,b9 as ge,ba as oe,S as we,bb as ie,M as ve}from"./icons-vendor-Bc_sqlcI.js";import{x as Ne,C as ye,$ as H,M as P,K as de,a as ce}from"./maplibre-vendor-v_HaOzn3.js";import{u as Me,a as Ce,v as Ee}from"./index-BNtSY0yE.js";typeof window<"u"&&ce&&(ce.WORKER_URL="/assets/maplibre-gl-worker.mjs");const F={OSM_FR:{id:"OSM_FR",name:"Plan Urbain Complet (Rues & Lieux)",tiles:["https://a.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png","https://b.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png","https://c.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png"],attribution:"&copy; OpenStreetMap France contributors"},ESRI_STREETS:{id:"ESRI_STREETS",name:"Esri World Streets (Détaillé)",tiles:["https://server.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}"],attribution:"&copy; Esri, HERE, Garmin, OpenStreetMap"},SATELLITE:{id:"SATELLITE",name:"Vue Satellite HD (Bâtiments réels)",tiles:["https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}"],attribution:"&copy; Esri, Maxar, Earthstar Geographics"},VOYAGER:{id:"VOYAGER",name:"Carto Voyager (Épuré)",tiles:["https://a.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png","https://b.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png","https://c.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png","https://d.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png"],attribution:"&copy; CARTO &copy; OpenStreetMap"}},Le=[{id:"GOLD_CYAN",label:"Doré & Cyan (Haute Clarté)",iconColor:"bg-amber-400",desc:"Grands axes dorés et rues nettes"},{id:"NEON_CYBER",label:"Néon Cyberpunk (Sombre)",iconColor:"bg-cyan-400",desc:"Radar de nuit avec routes fluorescentes"},{id:"SILVER_SLATE",label:"Silver Épuré (Minimaliste)",iconColor:"bg-slate-300",desc:"Rendu monochrome moderne"},{id:"NATURAL",label:"Couleurs Naturelles (Standard)",iconColor:"bg-emerald-400",desc:"Rendu topographique officiel"}],ke=k=>{const t=F[k]||F.OSM_FR;return{version:8,sources:{"base-tiles":{type:"raster",tiles:t.tiles,tileSize:256,attribution:t.attribution||"&copy; OpenStreetMap"}},layers:[{id:"base-tiles-layer",type:"raster",source:"base-tiles",minzoom:0,maxzoom:19}]}},p={PLUMBING:`
  ...
  `},pe=k=>{const t=String(k||"").toUpperCase();return t.includes("CLIM")||t.includes("FROID")||t.includes("HVAC")||t.includes("AIR")?p.CLIMATISATION:t.includes("PLOMB")||t.includes("PLUMB")||t.includes("EAU")?p.PLUMBING:t.includes("ELEC")||t.includes("VOLT")||t.includes("COURANT")?p.ELECTRICIAN:t.includes("AUTO")||t.includes("CAR")||t.includes("LAVAGE")||t.includes("MECAN")?p.AUTO_MECHANIC:t.includes("MENUIS")||t.includes("CARPENTER")||t.includes("WOOD")||t.includes("BOIS")?p.MENUISERIE:t.includes("SERRUR")||t.includes("KEY")||t.includes("LOCK")||t.includes("PORTE")?p.SERRURERIE:t.includes("PEINT")||t.includes("PAINT")||t.includes("DECO")?p.PEINTURE:t.includes("MACON")||t.includes("BRICK")||t.includes("BATIMENT")||t.includes("CIMENT")?p.MACONNERIE:t.includes("ELECTRO")||t.includes("MULTIMEDIA")||t.includes("TV")?p.ELECTROMENAGER:t.includes("JARDIN")||t.includes("GARDEN")||t.includes("PLANT")?p.JARDINAGE:t.includes("NETT")||t.includes("MENAGE")||t.includes("CLEAN")?p.NETTOYAGE:t.includes("DERAT")||t.includes("DESINF")||t.includes("PEST")?p.DERATISATION:t.includes("PISCINE")||t.includes("POOL")||t.includes("WAVE")?p.PISCINE:p.PLUMBING},Ge=({mode:k="CLIENT_PICKER",selectedLat:t,selectedLng:f,onLocationSelect:y,filterCategory:ue})=>{var ne;const{user:j}=Me(),{interventions:O,maalems:I,calculateDistanceInKm:K,showToast:M,isMaalemOnline:je,toggleMaalemOnlineStatus:Te}=Ce(),Y=!!(j&&(String(j.role||"").toUpperCase()==="MAALEM"||String(j.role||"").toUpperCase()==="ADMIN")),V=c.useRef(null),u=c.useRef(null),T=(()=>{try{return JSON.parse(localStorage.getItem("bricolemoi_client_gps")||"null")}catch{return null}})(),J=t||(T==null?void 0:T.lat)||33.5883,W=f||(T==null?void 0:T.lng)||-7.6328,[R,xe]=c.useState("OSM_FR"),[q,fe]=c.useState("GOLD_CYAN"),[i,Q]=c.useState({lat:J,lng:W}),[A,me]=c.useState({}),[X,ee]=c.useState(!1),[w,U]=c.useState(!1),[te,$]=c.useState(!1),[se,z]=c.useState(!1),C=c.useRef({}),g=c.useRef({}),E=c.useRef(null),v=c.useRef(null);c.useEffect(()=>{if(!V.current)return;E.current=null,v.current=null,C.current={},g.current={};const s=new Ne({container:V.current,style:ke(R),center:[W,J],zoom:14.5,minZoom:10,maxZoom:19,pitch:0,bearing:0,antialias:!0,attributionControl:!1});s.addControl(new ye({showCompass:!0}),"top-right"),u.current=s,s.on("load",()=>{ee(!0),s.resize()});const l=setTimeout(()=>{s&&s.resize()},200);return s.on("click",o=>{y&&y(o.lngLat.lat,o.lngLat.lng)}),()=>{clearTimeout(l),E.current=null,v.current=null,C.current={},g.current={},ee(!1),s.remove()}},[R]),c.useEffect(()=>{u.current&&t&&f&&u.current.flyTo({center:[f,t],zoom:14.5,speed:1.2})},[t,f]),c.useEffect(()=>{const s={};(I||[]).forEach(l=>{s[l.id]={lat:l.lat,lng:l.lng}}),me(s)},[I]),c.useEffect(()=>{const s=u.current;if(!s||!X)return;if(E.current)E.current.setLngLat([i.lng,i.lat]),E.current.getElement().parentNode||E.current.addTo(s);else{const r=document.createElement("div");r.style.width="36px",r.style.height="36px",r.className="relative flex items-center justify-center cursor-pointer",r.innerHTML=`
      ...
      `;const a=new H({offset:25,className:"clean-trust-popup"}).setHTML(`<div class="bg-white/95 backdrop-blur-xl border border-slate-200/90 p-3 rounded-2xl text-center shadow-xl font-sans">
        ...
        </div>`);E.current=new P({element:r}).setLngLat([i.lng,i.lat]).setPopup(a).addTo(s)}const l=parseFloat(t||(i==null?void 0:i.lat)||33.5883),o=parseFloat(f||(i==null?void 0:i.lng)||-7.6328);if(k==="CLIENT_PICKER"&&!isNaN(l)&&!isNaN(o))if(v.current)v.current.setLngLat([o,l]),v.current.getElement().parentNode||v.current.addTo(s);else{const r=document.createElement("div");r.style.width="44px",r.style.height="52px",r.className="cursor-move transform -translate-y-full transition-transform hover:scale-110 z-30",r.innerHTML=`
        ...
        `;const a=new H({offset:25,className:"clean-trust-popup"}).setHTML(`<div class="bg-white/95 backdrop-blur-xl border border-slate-200/90 p-3 rounded-2xl text-center shadow-xl font-sans">
          ...
          </div>`);v.current=new P({element:r,draggable:!0}).setLngLat([o,l]).setPopup(a).addTo(s),v.current.on("dragend",()=>{const d=v.current.getLngLat();y&&y(d.lat,d.lng)})}const n=parseFloat(t||(i==null?void 0:i.lat)||33.5883),m=parseFloat(f||(i==null?void 0:i.lng)||-7.6328),h=(I||[]).filter(r=>{if(r.is_online!==!0||r.is_available===!1)return!1;const a=A[r.id]||{lat:r.lat,lng:r.lng},d=parseFloat(a.lat),x=parseFloat(a.lng);return!(isNaN(d)||isNaN(x)||d<20||d>38||x>=0)});Object.keys(C.current).forEach(r=>{h.some(d=>String(d.id).trim()===String(r).trim())||(C.current[r].remove(),delete C.current[r])}),h.forEach(r=>{const a=A[r.id]||{lat:r.lat,lng:r.lng},d=parseFloat(a.lat||33.5883),x=parseFloat(a.lng||-7.6328);if(isNaN(d)||isNaN(x)||d<20||d>38||x>=0)return;const G=j&&String(r.id).trim()===String(j.id).trim(),_=pe(r.specialty),N=K(n,m,d,x),D=Math.max(3,Math.round(N/30*60)),Z=(r.full_name||"Artisan Maâlem").split(" ").map(b=>b.charAt(0).toUpperCase()+b.slice(1).toLowerCase()).join(" ");if(!C.current[r.id]){const b=document.createElement("div");b.style.width="44px",b.style.height="44px",b.className="relative flex items-center justify-center cursor-pointer transform transition-transform hover:scale-125",G?b.innerHTML=`
          ...
          </div>`);C.current[r.id]=new P({element:b}).setLngLat([x,d]).setPopup(he).addTo(s)}}),Y?O.filter(a=>a.status==="PENDING").forEach(a=>{const d=parseFloat(a.lat||33.5883),x=parseFloat(a.lng||-7.6328);if(isNaN(d)||isNaN(x))return;const G=pe(a.service_type),_=K(i.lat,i.lng,d,x);if(g.current[a.id])g.current[a.id].setLngLat([x,d]),g.current[a.id].getElement().parentNode||g.current[a.id].addTo(s);else{const N=document.createElement("div");N.style.width="44px",N.style.height="44px",N.style.willChange="transform",N.className="relative flex items-center justify-center cursor-pointer transform transition-transform hover:scale-125",N.innerHTML=`
