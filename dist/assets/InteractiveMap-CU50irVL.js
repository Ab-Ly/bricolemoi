import{j as e,m as L}from"./motion-vendor-tYxtgyNX.js";import{r as c,b8 as be,b9 as ge,ba as ie,S as we,bb as de,M as ve}from"./icons-vendor-Bc_sqlcI.js";import{x as Ne,C as ye,$ as H,M as P,K as ce,a as pe}from"./maplibre-vendor-v_HaOzn3.js";import{u as Me,a as Ce,v as Ee}from"./index-DdCe7dTv.js";typeof window<"u"&&pe&&(pe.WORKER_URL="/assets/maplibre-gl-worker.mjs");const F={OSM_FR:{id:"OSM_FR",name:"Plan Urbain Complet (Rues & Lieux)",tiles:["https://a.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png","https://b.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png","https://c.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png"],attribution:"&copy; OpenStreetMap France contributors"},ESRI_STREETS:{id:"ESRI_STREETS",name:"Esri World Streets (Détaillé)",tiles:["https://server.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}"],attribution:"&copy; Esri, HERE, Garmin, OpenStreetMap"},SATELLITE:{id:"SATELLITE",name:"Vue Satellite HD (Bâtiments réels)",tiles:["https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}"],attribution:"&copy; Esri, Maxar, Earthstar Geographics"},VOYAGER:{id:"VOYAGER",name:"Carto Voyager (Épuré)",tiles:["https://a.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png","https://b.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png","https://c.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png","https://d.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png"],attribution:"&copy; CARTO &copy; OpenStreetMap"}},Le=[{id:"GOLD_CYAN",label:"Doré & Cyan (Haute Clarté)",iconColor:"bg-amber-400",desc:"Grands axes dorés et rues nettes"},{id:"NEON_CYBER",label:"Néon Cyberpunk (Sombre)",iconColor:"bg-cyan-400",desc:"Radar de nuit avec routes fluorescentes"},{id:"SILVER_SLATE",label:"Silver Épuré (Minimaliste)",iconColor:"bg-slate-300",desc:"Rendu monochrome moderne"},{id:"NATURAL",label:"Couleurs Naturelles (Standard)",iconColor:"bg-emerald-400",desc:"Rendu topographique officiel"}],ke=k=>{const t=F[k]||F.OSM_FR;return{version:8,sources:{"base-tiles":{type:"raster",tiles:t.tiles,tileSize:256,attribution:t.attribution||"&copy; OpenStreetMap"}},layers:[{id:"base-tiles-layer",type:"raster",source:"base-tiles",minzoom:0,maxzoom:19}]}},x={PLUMBING:`
  ...
  `},ue=k=>{const t=String(k||"").toUpperCase();return t.includes("CLIM")||t.includes("FROID")||t.includes("HVAC")||t.includes("AIR")?x.CLIMATISATION:t.includes("PLOMB")||t.includes("PLUMB")||t.includes("EAU")?x.PLUMBING:t.includes("ELEC")||t.includes("VOLT")||t.includes("COURANT")?x.ELECTRICIAN:t.includes("AUTO")||t.includes("CAR")||t.includes("LAVAGE")||t.includes("MECAN")?x.AUTO_MECHANIC:t.includes("MENUIS")||t.includes("CARPENTER")||t.includes("WOOD")||t.includes("BOIS")?x.MENUISERIE:t.includes("SERRUR")||t.includes("KEY")||t.includes("LOCK")||t.includes("PORTE")?x.SERRURERIE:t.includes("PEINT")||t.includes("PAINT")||t.includes("DECO")?x.PEINTURE:t.includes("MACON")||t.includes("BRICK")||t.includes("BATIMENT")||t.includes("CIMENT")?x.MACONNERIE:t.includes("ELECTRO")||t.includes("MULTIMEDIA")||t.includes("TV")?x.ELECTROMENAGER:t.includes("JARDIN")||t.includes("GARDEN")||t.includes("PLANT")?x.JARDINAGE:t.includes("NETT")||t.includes("MENAGE")||t.includes("CLEAN")?x.NETTOYAGE:t.includes("DERAT")||t.includes("DESINF")||t.includes("PEST")?x.DERATISATION:t.includes("PISCINE")||t.includes("POOL")||t.includes("WAVE")?x.PISCINE:x.PLUMBING},Ge=({mode:k="CLIENT_PICKER",selectedLat:t,selectedLng:h,onLocationSelect:y,filterCategory:xe})=>{var oe;const{user:j}=Me(),{interventions:O,maalems:T,calculateDistanceInKm:K,showToast:M,isMaalemOnline:je,toggleMaalemOnlineStatus:Te}=Ce(),Y=!!(j&&(String(j.role||"").toUpperCase()==="MAALEM"||String(j.role||"").toUpperCase()==="ADMIN")),V=c.useRef(null),f=c.useRef(null),I=(()=>{try{return JSON.parse(localStorage.getItem("bricolemoi_client_gps")||"null")}catch{return null}})(),J=t||(I==null?void 0:I.lat)||33.5883,W=h||(I==null?void 0:I.lng)||-7.6328,[R,fe]=c.useState("OSM_FR"),[q,me]=c.useState("GOLD_CYAN"),[i,Q]=c.useState({lat:J,lng:W}),[A,X]=c.useState({}),[ee,te]=c.useState(!1),[w,U]=c.useState(!1),[se,$]=c.useState(!1),[re,z]=c.useState(!1),C=c.useRef({}),g=c.useRef({}),E=c.useRef(null),v=c.useRef(null);c.useEffect(()=>{if(!V.current)return;E.current=null,v.current=null,C.current={},g.current={};const s=new Ne({container:V.current,style:ke(R),center:[W,J],zoom:14.5,minZoom:10,maxZoom:19,pitch:0,bearing:0,antialias:!0,attributionControl:!1});s.addControl(new ye({showCompass:!0}),"top-right"),f.current=s,s.on("load",()=>{te(!0),s.resize()});const o=setTimeout(()=>{s&&s.resize()},200);return s.on("click",n=>{y&&y(n.lngLat.lat,n.lngLat.lng)}),()=>{clearTimeout(o),E.current=null,v.current=null,C.current={},g.current={},te(!1),s.remove()}},[R]),c.useEffect(()=>{f.current&&t&&h&&f.current.flyTo({center:[h,t],zoom:14.5,speed:1.2})},[t,h]),c.useEffect(()=>{const s={};(T||[]).forEach(n=>{s[n.id]={lat:n.lat,lng:n.lng}}),X(s);const o=setInterval(()=>{X(n=>{const l={...n};return(T||[]).forEach(p=>{const u=l[p.id]||{lat:p.lat,lng:p.lng};if(u.lat&&u.lng){const r=(Math.random()-.5)*2e-4,a=(Math.random()-.5)*2e-4;l[p.id]={lat:u.lat+r,lng:u.lng+a}}}),l})},4e3);return()=>clearInterval(o)},[T]),c.useEffect(()=>{const s=f.current;if(!s||!ee)return;if(E.current)E.current.setLngLat([i.lng,i.lat]),E.current.getElement().parentNode||E.current.addTo(s);else{const r=document.createElement("div");r.style.width="36px",r.style.height="36px",r.className="relative flex items-center justify-center cursor-pointer",r.innerHTML=`
      ...
      `;const a=new H({offset:25,className:"clean-trust-popup"}).setHTML(`<div class="bg-white/95 backdrop-blur-xl border border-slate-200/90 p-3 rounded-2xl text-center shadow-xl font-sans">
        ...
        `;const a=new H({offset:25,className:"clean-trust-popup"}).setHTML(`<div class="bg-white/95 backdrop-blur-xl border border-slate-200/90 p-3 rounded-2xl text-center shadow-xl font-sans">
          ...
          </div>`);v.current=new P({element:r,draggable:!0}).setLngLat([n,o]).setPopup(a).addTo(s),v.current.on("dragend",()=>{const d=v.current.getLngLat();y&&y(d.lat,d.lng)})}const l=parseFloat(t||(i==null?void 0:i.lat)||33.5883),p=parseFloat(h||(i==null?void 0:i.lng)||-7.6328),u=(T||[]).filter(r=>{if(r.is_online!==!0||r.is_available===!1)return!1;const a=A[r.id]||{lat:r.lat,lng:r.lng},d=parseFloat(a.lat),m=parseFloat(a.lng);return!(isNaN(d)||isNaN(m)||d<20||d>38||m>=0)});Object.keys(C.current).forEach(r=>{u.some(d=>String(d.id).trim()===String(r).trim())||(C.current[r].remove(),delete C.current[r])}),u.forEach(r=>{const a=A[r.id]||{lat:r.lat,lng:r.lng},d=parseFloat(a.lat||33.5883),m=parseFloat(a.lng||-7.6328);if(isNaN(d)||isNaN(m)||d<20||d>38||m>=0)return;const G=j&&String(r.id).trim()===String(j.id).trim(),_=ue(r.specialty),N=K(l,p,d,m),D=Math.max(3,Math.round(N/30*60)),Z=(r.full_name||"Artisan Maâlem").split(" ").map(b=>b.charAt(0).toUpperCase()+b.slice(1).toLowerCase()).join(" ");if(!C.current[r.id]){const b=document.createElement("div");b.style.width="44px",b.style.height="44px",b.className="relative flex items-center justify-center cursor-pointer transform transition-transform hover:scale-125",G?b.innerHTML=`
          ...
          </div>`);C.current[r.id]=new P({element:b}).setLngLat([m,d]).setPopup(he).addTo(s)}}),Y?O.filter(a=>a.status==="PENDING").forEach(a=>{const d=parseFloat(a.lat||33.5883),m=parseFloat(a.lng||-7.6328);if(isNaN(d)||isNaN(m))return;const G=ue(a.service_type),_=K(i.lat,i.lng,d,m);if(g.current[a.id])g.current[a.id].setLngLat([m,d]),g.current[a.id].getElement().parentNode||g.current[a.id].addTo(s);else{const N=document.createElement("div");N.style.width="44px",N.style.height="44px",N.style.willChange="transform",N.className="relative flex items-center justify-center cursor-pointer transform transition-transform hover:scale-125",N.innerHTML=`
