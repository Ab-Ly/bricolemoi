      ...
      <div className="bg-white border border-slate-200/90 rounded-3xl p-4 sm:p-5 shadow-xs space-y-3.5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 text-xs text-slate-500 mt-0.5 flex-wrap">
                ...
                {maalem.ratingInfo.loyalty?.qualifyingCount > 0 && (
                  <span className="text-blue-700 font-bold bg-blue-50 px-2 py-0.5 rounded-md border border-blue-100 text-[10px] inline-flex items-center gap-1">
                    ...
                    <span>{maalem.ratingInfo.loyalty.currentCycleProgress}/4 pour 1 Lead SOS Offert</span>
                  </span>
                )}
              </div>
            </div>
          ...
          <button
            ...
            className={`py-2.5 px-4 rounded-2xl font-bold text-xs shadow-xs active:scale-95 transition-all cursor-pointer flex items-center justify-center gap-2 self-stretch sm:self-auto ${
        ...
        {/* Mini-Bandeau Solde & Action Recharge Rapide */}
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-2.5 border-t border-slate-100 items-center">
          <div className="p-2.5 bg-slate-50 rounded-2xl border border-slate-200 flex flex-col justify-center">
          ...
          <button
            ...
            className="py-2.5 px-3 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white rounded-2xl font-bold text-xs flex items-center justify-center gap-1.5 shadow-sm active:scale-95 transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="col-span-2 sm:col-span-1 py-2.5 px-3 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-2xl font-bold text-xs flex items-center justify-center gap-1.5 shadow-xs active:scale-95 transition-all cursor-pointer"
          >
            <Clock className="w-4 h-4 text-slate-500 shrink-0" />
            <span>Historique 15 DH</span>
          </button>
        </div>
      </div>
