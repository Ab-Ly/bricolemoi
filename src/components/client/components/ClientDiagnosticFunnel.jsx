                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span className="text-[10px] font-bold text-blue-700 bg-blue-50 px-2 py-0.5 rounded-lg border border-blue-200 shrink-0 whitespace-nowrap">
                          {isRtl ? 'اتفاق مباشر' : 'Accord Direct'}
                        </span>
                      </div>

                      {/* Puces descriptives concrètes sans coupure */}
                      <div className="flex flex-wrap gap-1.5 mt-2.5">
                        {((isRtl ? issue.tagsAr : issue.tags) || []).map((tag, idx) => (
                          <span
                            key={idx}
                            className="text-[10px] sm:text-[11px] font-medium bg-slate-50 border border-slate-200 text-slate-700 px-2 py-0.5 rounded-md"
                          >
                            {tag}
                          </span>
                        ))}
